...
**Live Faktencheck** is a real-time fact-checking system for German TV talk shows. It transcribes live audio, extracts factual claims, and fact-checks them using AI — displaying results in a live dashboard.
