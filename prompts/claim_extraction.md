...
<Ausschluss>
Das Feld `excluded_speakers` listet Personen, deren Aussagen vom Faktencheck ausgenommen sind. Ignoriere alle Aussagen dieser Personen vollständig — auch wenn sie überprüfbare Fakten enthalten. Der Abgleich erfolgt über den im Transkript aufgelösten echten Namen. Ein leeres Feld bedeutet: alle Sprecher werden berücksichtigt (Standardverhalten).
</Ausschluss>
