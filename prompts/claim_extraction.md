...
Output:
1. "Julia Berger: Die Versorgungssicherheit in Deutschland ist nicht gewäheleistet (Stand Mai 2025)."
...
Output:
1. "Der Industriestrompreis liegt bei 18 Cent pro kWh in Deutschland (im [Monat Jahr])."
...
Output:
1. "Die Arbeitslosigkeit in Deutschland liegt bei 6% (im [Monat Jahr])."
...
The user will provide the context (participants, date) and transcript to analyze. 