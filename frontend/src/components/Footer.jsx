    ...
    <footer className="app-footer">
      <div className="footer-content">
        <p className="footer-disclaimer">
          ...
          Künstlicher Intelligenz (KI) generiert. Die Inhalte können Fehler enthalten und sollten daher
          als Orientierungshilfe, nicht jedoch als alleinige Quelle zur Meinungsbildung herangezogen werden. Es wird keine Gewähr für
