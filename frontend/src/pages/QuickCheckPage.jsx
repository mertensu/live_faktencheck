  ...
  return (
    <div className="about-page">
      <div className="about-content">
        ...
        {submitting && (
          <p className="review-extracting quick-check-checking" role="status">
            <span className="review-extracting-gear" aria-hidden="true">⚙</span>
            Behauptung wird überprüft, bitte einen kleinen Moment Geduld…
          </p>
        )}
